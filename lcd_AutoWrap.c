...
// Give me a string you want to find the first word in,
// and an array to store the first word in ill give you
// the first word I find in that string and store it in
// the array you gave me to store it in.
